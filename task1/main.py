...
class Tag(object):
    def __init__(self, unpacked_tag):
        ...
        g = int(genre)
        self.genre = (id3v1_genres.genres[g]
                      if g < len(id3v1_genres.genres)
                      else 255)
        ...
        with open(file, "rb+") as bfile:
            ...
            if tag.genre == 255 and \
               self.__genre is not None:
                ...
                if self.__genre < len(id3v1_genres.genres):
                    tag.genre = id3v1_genres.genres[self.__genre]
